    ...
    <div class=" container mx-auto px-4 sm:px-12">
        ...
        <section id="crearProyecto" class="mb-4 mt-8">
            ...
            <header class="flex items-center justify-between">
                <h1 class="text-lg leading-6 font-medium text-black">Hola 🖐 asignemos un puesto de trabajo en el área {{$processe->name}} .</h1>
            ...
            <form
                method="POST"
                action="{{route('subprocesse.store')}}"
            >
                <x-inputinfo >
                    <x-slot name="label">Nombre</x-slot> name
                </x-inputinfo>
                <input type="hidden" value="{{$processe->id}}" name="processe_id">
{{--                 <x-inputinfo>
