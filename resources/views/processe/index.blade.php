...
@endphp
    ...
    <section class="px-4 sm:px-6 lg:px-5 xl:px-6 py-4 sm:pb-6 lg:pb-4 xl:pb-6 space-y-4">
        ...
        <header class="flex items-center justify-between">
            <h2 class="text-lg leading-6 font-medium text-black">Procesos</h2>
            <a href="{{ route('processe.create') }}"
                    ...
                    @foreach ($processes as $processe)
                        <li class="p-4 lg:w-1/3 sm:w-1/2 w-full">
                          ...
                          ">
                                ...
                                <a href="{{ route('processe.show', $processe) }} "
